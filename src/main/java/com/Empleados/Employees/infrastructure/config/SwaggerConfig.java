package com.Empleados.Employees.infrastructure.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI().components(components).info(new Info()
                        .title("Gestion de empleados App Spring Boot 3 API")
                        .version("1.0")
                        .description("Gestion de empleados App made in Spring Boot 3 with Swagger")
